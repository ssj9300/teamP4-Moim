...
public class AuthorityAdapter extends ArrayAdapter<MoimUser> {
    Activity activity;
    int resource;

    public AuthorityAdapter(Context context, int resource, List<MoimUser> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(item != null) {
            ...
            textView2.setText("성별 = " +item.getGender() + "생년월일 = " + item.getBirth() + "권한 = " + item.getPermit());
        }
        return convertView;
    }
}
