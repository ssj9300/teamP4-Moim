...
public class MainActivity extends AppCompatActivity
    ...
    String URL_joinMember = "http://192.168.0.93:8080/moim.4t.spring/insertUser.tople";

    AsyncHttpClient client;
    HttpResponse response_join;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        response_join=new HttpResponse(this);
    ...
    private void requestMe() {
        ...
        UserManagement.getInstance().me(keys, new MeV2ResponseCallback() {
            ...
            public void onSuccess(MeV2Response response) {
                ...
                client.post(URL_joinMember, params, response_join);
    ...
    class HttpResponse extends AsyncHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            String join_result = new String(responseBody);
            Log.d("[join]", "result : " + join_result);
        }
